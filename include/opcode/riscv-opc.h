...
#define MATCH_REV8_H 0x68805013
#define MASK_REV8_H 0xfff0707f
...
#define CSR_MICACHE       0x7c0
#define CSR_MDCACHE       0x7c1
#define CSR_MITCMCR       0x7c5
#define CSR_MDTCMCR       0x7c6
#define CSR_MHCR          0x7c7
#define CSR_MFPSTATUS     0x7c8
#define CSR_MPFPSP        0x7c9
#define CSR_MEXINFO       0x7ca
#define CSR_MECC_CODE     0x7cb
#define CSR_MECC_CTL      0x7cc
#define CSR_MECC_GUARD    0x7cd
#define CSR_MECC_STATUS1  0x7ce
#define CSR_MNMIMEPC      0xbc0
#define CSR_MNMIMCAUSE    0xbc1
#define CSR_MNMIMEXSTATUS 0xbc2
#define CSR_MSLEEPMODE    0xbc3
#define CSR_MEXSTATUS     0xbc4
#define CSR_MWARMRST      0xbc5
#define CSR_MNMIE         0xbc6
#define CSR_MRSTCAUSE     0xfc0
...
DECLARE_INSN(rev8_h, MATCH_REV8_H, MASK_REV8_H)
/* Vendor-specific (T-Head) XTheadBa instructions.  */
...
/* CoreLab new csrs */
DECLARE_CSR(mtvt, CSR_MTVT, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mnxti, CSR_MNXTI, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mintstatus, CSR_MINTSTATUS, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mintthresh, CSR_MINTTHRESH, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mscratchcsw, CSR_MSCRATCHCSW, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mscratchcswl, CSR_MSCRATCHCSWL, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(micache, CSR_MICACHE, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mdcache, CSR_MDCACHE, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mitcmcr, CSR_MITCMCR, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mdtcmcr, CSR_MDTCMCR, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mhcr, CSR_MHCR, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mfpstatus, CSR_MFPSTATUS, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mpfpsp, CSR_MPFPSP, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mexinfo, CSR_MEXINFO, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mecc_code, CSR_MECC_CODE, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mecc_ctl, CSR_MECC_CTL, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mecc_guard, CSR_MECC_GUARD, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mecc_status1, CSR_MECC_STATUS1, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mnmimepc, CSR_MNMIMEPC, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mnmimcause, CSR_MNMIMCAUSE, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mnmimexstatus, CSR_MNMIMEXSTATUS, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(msleepmode, CSR_MSLEEPMODE, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mexstatus, CSR_MEXSTATUS, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mwarmrst, CSR_MWARMRST, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mnmie, CSR_MNMIE, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(mrstcause, CSR_MRSTCAUSE, CSR_CLASS_I, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
